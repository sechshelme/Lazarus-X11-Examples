...
uses
  ...
  begin
    ...
    id := gtk_statusbar_get_context_id(GTK_STATUSBAR(statusbar), Pchar(s));
    WriteLn(id);
    gtk_statusbar_push(GTK_STATUSBAR(statusbar), id, Pchar(s));
  end;
  ...
  begin
    ...
    gtk_window_set_title(GTK_WINDOW(window), 'StausBar');
