...
{
  Automatically converted by H2Pas 1.0.0 from /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/xpm.h
  The following command line parameters were used:
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/xpm.h
    -p
    -T
    -S
    -d
    -c
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/xpm.pp
}
    ...
    PVisual  = ^Visual;
    PXColor  = ^XColor;
    PXpmAttributes  = ^XpmAttributes;
    PXpmColor  = ^XpmColor;
    PXpmColorSymbol  = ^XpmColorSymbol;
    PXpmExtension  = ^XpmExtension;
    PXpmImage  = ^XpmImage;
    PXpmInfo  = ^XpmInfo;
{$IFDEF FPC}
{$PACKRECORDS C}
...
{$endif}
    ...
    type
      PXpmColorSymbol = ^TXpmColorSymbol;
      ...
      TXpmInfo = record
          ...
          y_hotspot : dword;
          nextensions : dword;
          extensions : PXpmExtension;
        end;


      TXpmAllocColorFunc = function (para1:PDisplay; para2:TColormap; para3:Pchar; para4:PXColor; para5:pointer):longint;cdecl;


      TXpmFreeColorsFunc = function (para1:PDisplay; para2:TColormap; para3:PPixel; para4:longint; para5:pointer):longint;cdecl;
