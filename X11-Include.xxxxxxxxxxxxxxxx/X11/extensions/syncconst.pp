...
{
  Automatically converted by H2Pas 1.0.0 from /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/extensions/syncconst.h
  The following command line parameters were used:
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/extensions/syncconst.h
    -p
    -T
    -S
    -d
    -c
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/extensions/syncconst.pp
}
    ...
    Type
    PXSyncAlarm  = ^XSyncAlarm;
    PXSyncAlarmState  = ^XSyncAlarmState;
    PXSyncCounter  = ^XSyncCounter;
    PXSyncFence  = ^XSyncFence;
    PXSyncTestType  = ^XSyncTestType;
    PXSyncValue  = ^XSyncValue;
    PXSyncValueType  = ^XSyncValueType;
{$IFDEF FPC}
{$PACKRECORDS C}
{$ENDIF}
