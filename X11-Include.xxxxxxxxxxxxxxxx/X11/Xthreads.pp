...
{
  Automatically converted by H2Pas 1.0.0 from /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/Xthreads.h
  The following command line parameters were used:
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/Xthreads.h
    -p
    -T
    -S
    -d
    -c
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/Xthreads.pp
}
    ...
    Type
    Pchar  = ^char;
    Pxcondition_rec  = ^xcondition_rec;
    Pxcondition_t  = ^xcondition_t;
    Pxmutex_rec  = ^xmutex_rec;
    Pxmutex_t  = ^xmutex_t;
    Pxthread_key_t  = ^xthread_key_t;
    Pxthread_t  = ^xthread_t;
    Pxthread_waiter  = ^xthread_waiter;
{$IFDEF FPC}
{$PACKRECORDS C}
{$ENDIF}
...
type
  ...
  Pxthread_key_t = ^Txthread_key_t;
  Txthread_key_t = Tthread_key_t;

  Pxcondition_rec = ^Txcondition_rec;
  Txcondition_rec = Tcond_t;

  Pxmutex_rec = ^Txmutex_rec;
...
type
  ...
  Pxthread_waiter = ^Txthread_waiter;
  Txthread_waiter = record
      sem : THANDLE;
      next : Pxthread_waiter;
    end;
...
in define line 133 *)
function _Xthread_waiter:Pxthread_waiter;cdecl;external;
(* error 
...
{$endif}
    ...
    type
      Pxcondition_t = ^Txcondition_t;
      Txcondition_t = Pxcondition_rec;

      Pxmutex_t = ^Txmutex_t;
      Txmutex_t = Pxmutex_rec;
