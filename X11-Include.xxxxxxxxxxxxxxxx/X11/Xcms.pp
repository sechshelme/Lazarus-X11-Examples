...
{
  Automatically converted by H2Pas 1.0.0 from /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/Xcms.h
  The following command line parameters were used:
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/Xcms.h
    -p
    -T
    -S
    -d
    -c
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-Include/X11/Xcms.pp
}
    ...
    PVisual  = ^Visual;
    PXcmsCCC  = ^XcmsCCC;
    PXcmsCCCRec  = ^XcmsCCCRec;
    PXcmsCIELab  = ^XcmsCIELab;
    PXcmsCIELuv  = ^XcmsCIELuv;
    PXcmsCIEuvY  = ^XcmsCIEuvY;
    PXcmsCIExyY  = ^XcmsCIExyY;
    PXcmsCIEXYZ  = ^XcmsCIEXYZ;
    PXcmsColor  = ^XcmsColor;
    PXcmsColorFormat  = ^XcmsColorFormat;
    PXcmsColorSpace  = ^XcmsColorSpace;
    PXcmsConversionProc  = ^XcmsConversionProc;
    PXcmsFloat  = ^XcmsFloat;
    PXcmsFuncListPtr  = ^XcmsFuncListPtr;
    PXcmsFunctionSet  = ^XcmsFunctionSet;
    PXcmsPad  = ^XcmsPad;
    PXcmsPerScrnInfo  = ^XcmsPerScrnInfo;
    PXcmsRGB  = ^XcmsRGB;
    PXcmsRGBi  = ^XcmsRGBi;
    PXcmsTekHVC  = ^XcmsTekHVC;
{$IFDEF FPC}
{$PACKRECORDS C}
{$ENDIF}
...
type
  ...
  TXcmsCompressionProc = function (para1:TXcmsCCC; para2:PXcmsColor; para3:dword; para4:dword; para5:PBool):TStatus;cdecl;



  TXcmsWhiteAdjustProc = function (para1:TXcmsCCC; para2:PXcmsColor; para3:PXcmsColor; para4:TXcmsColorFormat; para5:PXcmsColor; 
  ...
  TXcmsDDConversionProc = function (para1:TXcmsCCC; para2:PXcmsColor; para3:dword; para4:PBool):TStatus;cdecl;



  TXcmsDIConversionProc = function (para1:TXcmsCCC; para2:PXcmsColor; para3:PXcmsColor; para4:dword):TStatus;cdecl;

  PXcmsConversionProc = ^TXcmsConversionProc;
  TXcmsConversionProc = TXcmsDIConversionProc;

  PXcmsFuncListPtr = ^TXcmsFuncListPtr;
  TXcmsFuncListPtr = PXcmsConversionProc;
