...
{Hello World !
Hallo Welt !}   45053.5849
{Hello World !
Hallo Welt !}   45053.5848
{Hello World !
Hallo Welt !}   45053.5840{Hello World !
Hallo Welt !}   45053.5846
{Hello World !
Hallo Welt !}   45053.5844
{Hello World !
Hallo Welt !}   45053.5840
...
//	XCopy(selection, (unsigned char*) argv[1], strlen(argv[1]));
	...
	XCopy(selection, (unsigned char*) hello, strlen(hello));
}
