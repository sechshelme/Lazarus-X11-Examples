...
char **argv;
{
    ...
    * resource database */
    ...
    win = XCreateSimpleWindow(display, RootWindow(display,screen_num),x, y, width, height, border_width, BlackPixel(display,
...
load_font(&font_info);/* Create GC for text and drawing */
