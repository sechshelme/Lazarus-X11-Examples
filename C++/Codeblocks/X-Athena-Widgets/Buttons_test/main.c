...
char **argv;
{
    ...
    n = 0;
    XtSetArg(wargs[n],XtNorientation,XtorientHorizontal);
    n++;
...
//
        ...
        buttons[nbuttons] = XtCreateWidget("btn" , commandWidgetClass, box, NULL, 0);
    ...
    command = XtCreateManagedWidget("Programm beenden fgh jjg hjhgj gg hh j", commandWidgetClass, box, NULL, 0);
