...
type
  ...
  Tflimage = record
    ...
    wy: cint;
    modified: cint;
    display: function(para1: Pflimage; para2: TFL_WINDOW): cint; cdecl;
    double_buffer: cint;
    sxd: cint;
    syd: cint;
    swd: cint;
    ...
    display_text: procedure(para1: Pflimage); cdecl;
    free_text: procedure(para1: Pflimage); cdecl;
    marker: PFLIMAGE_MARKER;
    nmarkers: cint;
    max_markers: cint;
    dont_display_marker: cint;
    display_markers: procedure(para1: Pflimage); cdecl;
    free_markers: procedure(para1: Pflimage); cdecl;
    pmin: cdouble;
    pmax: cdouble;
    poffset: cdouble;
    pscale: cdouble;
    ...
    post_write: function(para1: Pflimage): cint; cdecl;
    subx: cint;
    suby: cint;
    subw: cint;
    subh: cint;
    ...
    current_frame: cint;
    total_frames: cint;
    next_frame: function(para1: Pflimage): cint; cdecl;
    prev_frame: function(para1: Pflimage): cint; cdecl;
    random_frame: function(para1: Pflimage; para2: cint): cint; cdecl;
    rewind_frame: function(para1: Pflimage): cint; cdecl;
    cleanup: procedure(para1: Pflimage); cdecl;
    stop_looping: cint;
    fpin: PFILE;
    fpout: PFILE;
    image_io: pointer;
...
type
  TPCfloats = array[0..1] of Pcfloat;
