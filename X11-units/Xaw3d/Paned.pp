...
{
  Automatically converted by H2Pas 1.0.0 from /usr/include/X11/Xaw3d/Paned.h
  The following command line parameters were used:
    /usr/include/X11/Xaw3d/Paned.h
    -s
    -S
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-units/Xaw3d/Paned.pp
}
...
{$endif}
    ...
    procedure XawPanedGetMinMax(_para1:Widget; _para2:Plongint; _para3:Plongint);cdecl;
...
{$endif}
    ...
    procedure XawPanedSetRefigureMode(_para1:Widget; Boolean:longint);cdecl;
...
{$endif}
    ...
    function XawPanedGetNumSub(_para1:Widget):longint;cdecl;
...
{$endif}
    ...
    procedure XawPanedAllowResize(_para1:Widget; Boolean:longint);cdecl;
