...
{
  Automatically converted by H2Pas 1.0.0 from /usr/include/X11/Xaw3d/Reports.h
  The following command line parameters were used:
    /usr/include/X11/Xaw3d/Reports.h
    -s
    -S
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-units/Xaw3d/Reports.pp
}
