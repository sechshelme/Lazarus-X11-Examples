...
{
  Automatically converted by H2Pas 1.0.0 from /usr/include/X11/extensions/applewmconst.h
  The following command line parameters were used:
    /usr/include/X11/extensions/applewmconst.h
    -s
    -S
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-units/extensions/applewmconst.pp
}
