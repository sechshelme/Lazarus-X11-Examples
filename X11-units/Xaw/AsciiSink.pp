...
{
  Automatically converted by H2Pas 1.0.0 from /usr/include/X11/Xaw/AsciiSink.h
  The following command line parameters were used:
    /usr/include/X11/Xaw/AsciiSink.h
    -s
    -S
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-units/Xaw/AsciiSink.pp
}
