...
{
  Automatically converted by H2Pas 1.0.0 from /usr/include/X11/Xpoll.h
  The following command line parameters were used:
    /usr/include/X11/Xpoll.h
    -s
    -S
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-units/Xpoll.pp
}
...
{$if defined(BSD) && BSD < 198911 }
  ...
  type
    fd_set = record
        fds_bits : array[0..(howmany(FD_SETSIZE,NFDBITS))-1] of fd_mask;
      end;
{$endif}
