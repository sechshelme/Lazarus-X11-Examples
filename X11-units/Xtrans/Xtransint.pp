...
{
  Automatically converted by H2Pas 1.0.0 from /usr/include/X11/Xtrans/Xtransint.h
  The following command line parameters were used:
    /usr/include/X11/Xtrans/Xtransint.h
    -s
    -S
    -o
    /n4800/DATEN/Programmierung/mit_GIT/Lazarus/Tutorial/X11/X11-units/Xtrans/Xtransint.pp
}
...
{$endif}
  ...
  type
    _XtransConnInfo = record
        transptr : ^_Xtransport;
        index : longint;
        priv : ^char;
        flags : longint;
        fd : longint;
        ...
        peeraddr : ^char;
        peeraddrlen : longint;
        recv_fds : ^_XtransConnFd;
        send_fds : ^_XtransConnFd;
      end;
...
{$endif}
 ...
 in member_list *)
  ...
  type
    ...
    Xtransport = _Xtransport;

    _Xtransport_table = record
        transport : ^Xtransport;
        transport_id : longint;
      end;
    Xtransport_table = _Xtransport_table;
