...
//{$include <X11/RectObj.h>}
    type
      ...
      TXtTranslations = record end; //PTranslationData;

      PXtAccelerators = ^TXtAccelerators;
      TXtAccelerators = record end; //PTranslationData;
      ...
      TXtBoundActions = record end; //PXtActionProc;
...
procedure XtAppAddConverter(para1:TXtAppContext; _XtString:TXtString; __XtString:TXtString; para4:TXtConverter; para5:TXtConvertArgList;
...
procedure XtSetTypeConverter(_XtString:TXtString; __XtString:TXtString; para3:TXtTypeConverter; para4:TXtConvertArgList; para5:TCardinal; 
                para6:TXtCacheType; para7:TXtDestructor);cdecl;external libXt;

procedure XtAppSetTypeConverter(para1:TXtAppContext; _XtString:TXtString; __XtString:TXtString; para4:TXtTypeConverter; para5:TXtConvertArgList; 
...
procedure XtDisplayInitialize(para1:TXtAppContext; para2:PDisplay; _XtString:TXtString; __XtString:TXtString; para5:PXrmOptionDescRec; 
...
function XtOpenDisplay(para1:TXtAppContext; _XtString:TXtString; __XtString:TXtString; ___XtString:TXtString; para5:PXrmOptionDescRec; 
...
procedure XtAppWarningMsg(para1:TXtAppContext; _XtString:TXtString; __XtString:TXtString; ___XtString:TXtString; ____XtString:TXtString;
                para6:PString; para7:PCardinal);cdecl;external libXt;


procedure XtWarningMsg(_XtString:TXtString; __XtString:TXtString; ___XtString:TXtString; ____XtString:TXtString; para5:PString; 
...
procedure XtAppGetErrorDatabaseText(para1:TXtAppContext; _XtString:TXtString; __XtString:TXtString; ____XtString:TXtString; _____XtString:TXtString; 
                para6:TXtString; para7:longint; para8:TXrmDatabase);cdecl;external libXt;


procedure XtGetErrorDatabaseText(_XtString:TXtString; __XtString:TXtString; ___XtString:TXtString; ____XtString:TXtString; para5:TXtString;
...
function XtResolvePathname(para1:PDisplay; _XtString:TXtString; __XtString:TXtString; ___XtString:TXtString; ____XtString:TXtString; 
