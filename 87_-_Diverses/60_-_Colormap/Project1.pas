...
type
  ...
  begin
    ...
    gree_gc := XCreateGC(dis, win, 0, nil);
    XParseColor(dis, colormap, '#00FF00', @green_col);
    XAllocColor(dis, colormap, @green_col);
    XSetForeground(dis, gree_gc, green_col.pixel);
  end;
    ...
    while (True) do begin
      ...
      case Event._type of
        Expose: begin
          ...
          XFillRectangle(dis, win, gree_gc, 20, 20, 200, 200);
        end;
        KeyPress: begin
